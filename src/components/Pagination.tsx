...
const PageBtn = ({ page, onClick, currentPage }: IPageBtnProps) => {
  return (
    <Button
      ...
      noise={false}
      className={cn(
        "text-primary ring-primary ring-offset-secondary data-[pressed]:text-primary min-w-9 rounded-[calc(0.75rem-0.25rem)] bg-transparent p-1.5 text-sm ring-offset-0 [--rounded:calc(0.75rem-0.25rem)] hover:bg-white/50 data-[pressed]:bg-white/60 md:p-1.5",
        {
          "bg-primary hover:bg-primary text-white": page === currentPage,
        },
      )}
    >
      {page}
    ...
    return (
      <div className={cn("flex items-center justify-center gap-2", className)}>
        ...
        {!hideButtons && (
          <Button
            variant="ghost"
            className="bg-secondary text-primary ring-primary hover:bg-secondary/90 data-[pressed]:bg-secondary p-3 disabled:bg-gray-200 disabled:text-gray-400 md:p-3"
        ...
        {/* Page Buttons */}
        <div className="bg-secondary flex flex-wrap items-center justify-center rounded-xl p-1">
          {renderPageButtons()}
        </div>
