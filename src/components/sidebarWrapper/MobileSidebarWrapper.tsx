      ...
      <AnimatePresence>
        {isSidebarVisible && (
          <motion.aside
            ...
            className={cn(
              "bg-dark fixed inset-0 left-0 z-[99999999999999] flex h-full w-72 flex-shrink-0 flex-col shadow-xl md:hidden",
              className,
            )}
            {...rest}
          >
      ...
      <AnimatePresence>
        {isSidebarVisible && (
          <motion.div
            ...
            className="fixed inset-0 z-[999999999] bg-black/20 backdrop-blur-sm md:hidden"
          ></motion.div>
        )}
      </AnimatePresence>
      {/* backdrop */}
